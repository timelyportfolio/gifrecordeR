...
Easily record animated GIFs of your `R` web session straight client side with this `htmlwidget wrapper` for [gifw00t](https://github.com/yaronn/gifw00t).  Use it for documentation, illustration, or fun.

Thanks to all the code and amazing examples from [Yaron Naveh \@yaronn](https://twitter.com/YaronNaveh).  See his other unbelievable work, such as the >6,000 star [blessed-contrib](https://github.com/yaronn/blessed-contrib)  He deserves all the credit and praise for this.  I simply the `htmlwidget` wrapper.
